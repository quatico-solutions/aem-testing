...
public class MockResourceResolverTest extends ResourceResolverTestDriver {
	@Override
	...
	@Test
	public void resolveRequestResourceWithNullRequestAndNullResourceReturnsUnstructuredResource() throws Exception {
		assertEquals("nt:unstructured", this.testObj.resolve(null, null).getResourceType());
	}
}
